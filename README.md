...
| `Sources/NHVCore/Networking` | 类型化 API、传输接口、状态码与参数校验 |
| `Sources/NHVCore/Models` | 作品、标签、本人账号和分页模型 |
| `Sources/NHVCore/Session` | Keychain 与会话生命周期 |
| `Sources/NHVCore/Media` | CDN 配置到媒体 URL 的解析 |
| `Tests/NHVCoreTests` | 独立于 UI 的基础层测试 |
